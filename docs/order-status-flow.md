# Статусы заказа Tagam / KMRS

Customer app должен следовать модели трекинга из коробочной KMRS MobileVue. В backend есть несколько внутренних потоков статусов, но клиентский UI должен оставаться простым и не показывать кухонные/курьерские технические детали слишком рано.
