# Аудит расхождений с коробочной Tagam legacy app

База для сравнения: `C:\Users\ps\Documents\Tagam\legacy app`.

Цель: переносить серверную логику и пользовательские сценарии коробки, но не терять новый Tagam UI.

## Checkout / оформление заказа

| Зона | Как в коробке legacy app | Как сейчас в Tagam app | Статус |
| --- | --- | --- | --- |
