<template>
  <q-pull-to-refresh @refresh="refresh">
    ...
    <q-page class="tagam-menu-carousel-page">
      ...
      <div
        ...
        :class="{ 'relative-position': $q.dark.mode, '': !$q.dark.mode, }"
      >
        ...
        <div class="q-pl-md q-pr-md">
          ...
          <div class="row items-center justify-between">
            ...
            >
              ...
              >
                <span class="text-weight-medium tagam-text-main font12 text-grey">
                  <span
                    class="text-weight-bold"
                    :class="{ 'text-grey300': $q.dark.mode, 'tagam-text-main': !$q.dark.mode, }"
            ...
            >
              <span
                class="text-weight-medium tagam-text-main font12 text-grey line-normal"
            ...
            >
              ...
              >
                <span
                  class="text-weight-medium tagam-text-main font12 text-grey ellipsis fit"
                >
          ...
          <template v-if="StoreOpen.store_close">
            <div
              ...
              :class="{ 'bg-grey600 text-grey300': $q.dark.mode, 'bg-yellow': !$q.dark.mode, }"
            >
      ...
      <q-page-scroller
        ...
        :scroll-offset="150"
        :offset="[18, 18]"
       class="tagam-menu-carousel-page">
        <q-btn
          fab
    ...
    <q-footer
      ...
      reveal
      class="bg-primary q-pl-md q-pr-md q-pb-sm q-pt-sm tagam-text-main"
    >
      <q-btn
        to="/cart"
    ...
    classObject() {
      ...
      if (this.headerChangeColor) {
        $class_name = this.$q.dark.mode
          ? "tagam-surface-elevated text-white"
