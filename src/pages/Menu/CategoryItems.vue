<template>
  ...
  <q-page class="tagam-menu-category-items-page">
    <q-pull-to-refresh @refresh="refresh" color="primary" bg-color="white">
      ...
      <div class="q-pl-md q-pr-md q-pt-md">
        ...
        <div
          v-else
          class="tagam-surface-muted text-subtitle2 q-pa-sm radius28 flex items-center cursor-pointer"
      ...
      <template v-if="CartStore.hasItem && !CartStore.cart_loading">
        <q-page-sticky position="bottom-right" :offset="[18, 18]" class="tagam-menu-category-items-page">
          <q-btn
            fab
      ...
      <q-page-scroller
        ...
        :scroll-offset="150"
        :offset="[18, 18]"
       class="tagam-menu-category-items-page">
        <q-btn
          fab
...
export default {
  ...
  methods: {
    ...
    async loadCart() {
      await this.CartStore.getCart(true, null, this.slug);
      this.promoCheck();
    },
