<template>
  ...
  <q-page padding class="tagam-order-rate-driver-page">
    <q-inner-loading :showing="loading2" color="primary"></q-inner-loading>
    <q-card flat v-if="driver_info" class="tagam-rate-driver-card">
      <div class="text-center q-pt-lg">
        <q-avatar size="88px" class="tagam-rate-driver-avatar">
          <q-img
        ...
        <div class="tagam-title-lg q-px-md">
          {{ $t("Let's rate your driver's delivery service") }}
        </div>
        <p class="tagam-body-muted q-px-md">{{ $t("How was the delivery of your order?") }}</p>
        ...
        <div style="width: 80%; margin: auto">
          <div class="flex-content w-100 q-gutter-sm">
            <template v-for="items in data_like_options" :key="items">
              <div class="flex-content-item">
                <q-btn
                  ...
                  :color="review_text == items ? 'primary' : 'grey-4'"
                  :text-color="review_text == items ? 'white' : 'dark'"
...
<style scoped>
.tagam-order-rate-driver-page {
  background: var(--tagam-page-gradient);
}

.tagam-rate-driver-card {
