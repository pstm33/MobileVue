<template>
  <q-pull-to-refresh @refresh="refresh" color="primary" bg-color="white">
    ...
    <q-page class="tagam-booking-list-page">
        ...
        <q-card-section class="q-pt-none">
          ...
          >
            <template
              ...
              :key="items"
            >
              <q-tab :name="index" :label="items" class="radius28 tagam-surface-muted" />
            </template>
          </q-tabs>
                  ...
                  <template v-slot:default>
                    ...
                    <template v-else>
                      <template v-for="(items, index) in data" :key="items">
                        <!-- <router-link class="tagam-text-main" to="#" @click.prevent> -->
                        <q-card
                          class="myshadow-1"
                        ...
                        >
                          <q-list dense>
                            <q-item-label
                              header
                              class="tagam-surface-muted text-blue-grey-6"
