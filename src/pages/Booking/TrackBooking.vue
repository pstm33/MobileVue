<template>
  <q-pull-to-refresh @refresh="refresh">
    ...
    <q-page
      class="q-pl-md q-pr-md tagam-booking-track-booking-page"
    ...
    >
      ...
      <template v-if="BookingStore.hasBookingData">
        <div class="q-pa-sm tagam-surface-muted radius10">
          <q-stepper
            v-model="steps"
            ref="stepper"
            contracted
        ...
        <div class="q-pa-sm radius10">
          <div class="text-weight-medium font15 q-pa-sm tagam-surface-muted radius10">
      ...
      <q-footer
        reveal
        class="bg-primary tagam-text-main"
