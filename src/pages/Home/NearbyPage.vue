<template>
  <q-page padding class="tagam-home-nearby-page">
     <q-carousel
      v-model="slide"
    ...
    <q-carousel-slide v-for="i in 2" :key="i" :name="i"  class="column no-wrap flex-center q-pa-none"  >
       <q-img class="fit" src="banner3.jpg" fit="cover" loading="lazy" />
     </q-carousel-slide>
    </q-carousel>
   ...
   <div class="q-mt-md q-mb-md">
    ...
    <p class="font11 tagam-text-muted">200+ Restaurants found near you</p>
   </div>
   ...
   <q-list class="qlist-no-padding">
     <q-item  to="/menu"  clickable v-ripple >
       ...
       <q-item-section>
         ...
         <div class="font11 full-width tagam-text-muted ellipsis">Chinese, american, italian</div>
         <div class="row q-mt-sm">
           <div class="col-3">
             <q-chip size="sm" color="white" text-color="warning" icon="star" class="no-padding transparent" >
               <span class="text-weight-medium tagam-text-main">4.5</span>
             </q-chip>
           </div>
           <div class="col">
     ...
     <q-item  to="/menu"  clickable v-ripple v-for="i in 3" :key="i" >
       ...
       <q-item-section>
         ...
         <div class="font11 tagam-text-muted ellipsis">Chinese, american, italian</div>
         <div class="row q-mt-sm">
           <div class="col-3">
             <q-chip size="sm" color="white" text-color="warning" icon="star" class="no-padding transparent" >
               <span class="text-weight-medium tagam-text-main">4.5</span>
