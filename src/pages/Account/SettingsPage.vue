<template>
  ...
  <q-page padding class="tagam-surface-muted q-pl-md q-pr-md row items-stretch tagam-account-settings-page">
    <q-inner-loading
      v-if="loading"
      :showing="true"
      color="primary"
    ...
    <q-card v-else flat class="tagam-surface tagam-account-card col-12">
      <q-list>
        <q-item>
          <q-item-section>
