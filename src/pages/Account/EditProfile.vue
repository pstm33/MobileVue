    ...
    <q-form @submit="checkForm" class="myform">
      ...
      <div class="tagam-section-heading tagam-section-heading--stacked">
        <div>
          ...
          <div class="tagam-section-heading__title">{{ $t("Edit Profile") }}</div>
        </div>
        <div class="tagam-section-heading__meta">
          {{ $t("Update your personal information and account details") }}
        </div>
      </div>
      <div class="q-pb-md flex flex-center items-center">
        <div>
          <q-item clickable>
