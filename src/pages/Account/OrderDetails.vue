<template>
  <q-pull-to-refresh @refresh="refresh">
    ...
    <q-page class="tagam-account-page b q-pl-md q-pr-md q-pb-md tagam-account-header">
            ...
            <q-item-section>
              ...
              <q-item-label caption class="font12">
                <div class="text-weight-bold">
                  {{ cleanText(order_info.payment_name) }}
                </div>
                <div class="text-weight-light font11">
                  {{ cleanText(order_info.place_on) }}
                </div>
              </q-item-label>
            </q-item-section>
          ...
          <q-list class="q-pb-md">
            <q-item>
              <q-item-section>
                <q-item-label
                  lines="1"
                  class="text-weight-medium tagam-text-muted font13"
                >
                  ...
                  <q-item-label class="text-weight-bold q-mb-xs font12">
                    <p class="no-margin">
                      ...
                      <template v-if="items.item_changes == 'replacement'">
                        <div class="m-0 tagam-text-muted">
              ...
              <template v-if="summary.type == 'total'">
                ...
                <q-item dense class="q-pb-none" style="min-height: auto">
                  <q-item-section class="font13 text-weight-medium">{{
                    displaySummaryName(summary.name)
                  }}</q-item-section>
              ...
              >
                ...
                >
                  ...
                  <q-icon
                    ...
                    size="15px"
                    class="tagam-text-muted q-ml-sm"
                  />
                </q-btn>
              </div>
              <div class="col">
    ...
    <q-footer
      v-if="!loading"
      class="tagam-surface-muted row q-gutter-md q-pl-md q-pr-md q-pb-sm tagam-text-main"
    >
      <q-btn
...
export default {
  ...
  methods: {
    cleanText(value) {
      const label = formatReadableDateTime(normalizeBackendLabel(value));
      const preparingMatch = String(label).match(/^(.+)\s+is preparing your order\.?$/i);
      if (preparingMatch) {
