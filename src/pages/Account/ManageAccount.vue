<template>
  <q-header class="tagam-account-header tagam-surface tagam-text-main">
    <q-toolbar>
      <q-btn
        to="/account/profile"
        flat
  ...
  <q-page padding class="tagam-surface-muted tagam-account-manage-account-page">
    ...
    <q-card flat class="tagam-surface tagam-account-card">
      <q-card-section class="q-pa-md">
        <template v-if="account_deleted">
          ...
          <p class="font12 tagam-text-muted">
        ...
        <template v-else>
          <div class="text-h6 text-weight-bold">{{ $t("Account Data") }}</div>
          <p class="font12 tagam-text-muted">
          ...
          <div class="text-h6 text-weight-bold">{{ $t("Delete Account") }}</div>
          <p class="font12 tagam-text-muted">
