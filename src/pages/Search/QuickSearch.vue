<template>
  <q-header class="tagam-quick-search-header">
    <div class="tagam-quick-search-header-shell">
    <q-toolbar class="text-dark tagam-quick-search-toolbar">
      <q-btn
        @click="$router.back()"
        color="white"
        rounded
  ...
  <div class="q-pa-sm q-pr-md q-pl-md tagam-quick-search-meta">
    <div class="row">
  ...
  <q-page class="tagam-quick-search-page">
    <q-tabs
      v-model="tab"
      dense
      class="text-grey"
...
.tagam-quick-search-header {
  background: transparent !important;
  box-shadow: none !important;
  padding: 10px 12px 0;
}

.tagam-quick-search-header-shell {
...
.tagam-quick-search-toolbar {
  min-height: 72px;
}

.tagam-quick-search-meta {
  background: transparent;
}

:deep(.tagam-quick-search-header .q-field--outlined .q-field__control) {
  border-radius: 20px;
