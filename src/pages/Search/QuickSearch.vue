<template>
  <q-header class="tagam-search-header">
    <q-toolbar>
      <q-btn
        @click="$router.back()"
        color="white"
  ...
  <div class="q-pa-sm q-pr-md q-pl-md tagam-surface-muted">
    <div class="row">
  ...
  <q-page class="tagam-search-quick-search-page">
    <q-tabs
      v-model="tab"
      dense
              ...
              >
                <q-item-section avatar>
                  <q-img
                    ...
                    fit="cover"
                    loading="lazy"
                    class="tagam-restaurant-logo-stretch"
                ...
                <q-item-section class="font12">
                  ...
                  <p
                    class="font11 tagam-text-muted height-normal no-margin ellipsis-2-lines"
                  >
                    <template
          ...
          <div v-else class="fit q-mt-xl text-center q-pa-md flex flex-center">
            <div v-if="isSearch">
              <q-img
                ...
                class="light-dimmed"
              />
              <p class="font11 tagam-text-muted">
                {{ $t("No results for") }} "{{ q }}"
              </p>
            </div>
          </div>
              ...
              <q-item clickable v-ripple @click="onClickitem(items)">
                <q-item-section avatar>
                  <q-img
                    ...
                    fit="fill"
                    style="height: 50px; width: 50px"
                    class="rounded-borders tagam-media-1x1"
                    spinner-color="amber"
                    spinner-size="sm"
                  />
                </q-item-section>
                <q-item-section>
                  ...
                  >
                    ...
                    <p
                      ...
                      class="font11 tagam-text-muted no-margin"
                    >
  ...
  <q-footer
    ...
    reveal
    class="tagam-surface q-pl-md q-pr-md q-pb-sm q-pt-sm tagam-text-main"
  >
    <q-btn
      to="/cart"
