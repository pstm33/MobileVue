<template>
  ...
  <q-page class="q-pl-md q-pr-md row items-stretch tagam-search-items-page">
    <div class="col-12">
      <q-input
        v-model="q"
        :label="$t('Search')"
  ...
  <q-footer
    ...
    reveal
    class="q-pl-md q-pr-md q-pb-sm q-pt-sm tagam-text-main"
    :class="{ 'bg-primary': !CartStore.cart_reloading, 'bg-grey-5': CartStore.cart_reloading, }"
  >
    <q-btn
      to="/checkout"
