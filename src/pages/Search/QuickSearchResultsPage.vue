<template>
  <q-page padding class="tagam-search-quick-search-results-page">
     <q-input
      v-model="q"
            ...
            <q-item clickable v-ripple>
              ...
              <q-item-section class="font12">
                <div class="font12 text-weight-medium q-mb-xs">Chipotle Mexican Grill</div>
                 <p class="font11 tagam-text-muted height-normal no-margin ellipsis-2-lines">Chinese, american, italian &bull; $$</p>
              </q-item-section>
            </q-item>
