const routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        component: () => import("src/pages/Theme/ThemePreviewPage.vue"),
      },
    ],
  },
  {
    ...
    children: [
...

      {
        ...
        name: "review",
        props: true,
        component: () => import("src/pages/Menu/ReviewList.vue"),
      },
    ],
  },
  {
...

  {
    ...
    children: [
      {
        path: "",
        component: () => import("src/pages/Legal/ExternalLegalPage.vue"),
        props: {
          title: "Data Deletion",
          url: "https://tagam.delivery/data-deletion",
        },
      },
    ],
  },

  {
    ...
    children: [
      ...
      {
        path: "apple_callback",
        component: () => import("src/pages/User/AppleCallback.vue"),
      },
      {
        path: "reset-password",
