<template>
  <q-layout view="lHh Lpr lFf">
    <q-header reveal class="" @reveal="revealStateChange">
      <q-toolbar
    ...
    <q-footer bordered class="text-dark tagam-bottom-nav tagam-footer" style="background:#f7f4ea !important; border-top:1px solid #e7dcc7 !important; box-shadow:none !important;">
      <q-tabs
        v-model="tab"
        dense
        ...
        style="background:#f7f4ea !important;"
        :class="{
          'bg-mydark text-white': $q.dark.mode,
          'text-dark': !$q.dark.mode,
        } tagam-bottom-tabs"
...
<style>
.tagam-bottom-nav,
.tagam-bottom-nav .q-tabs,
.tagam-bottom-nav .q-tabs__content,
.tagam-bottom-tabs {
  background: #f7f4ea !important;
}

.tagam-bottom-nav {
  border-top: 1px solid #e7dcc7 !important;
  box-shadow: none !important;
}

.tagam-bottom-nav .q-tab {
  min-height: 62px;
  color: #8f8f8f !important;
}

.tagam-bottom-nav .q-tab__label {
  font-size: 12px;
  font-weight: 500;
}

.tagam-bottom-nav .q-tab--active,
.tagam-bottom-nav .q-tab--active .q-icon,
.tagam-bottom-nav .q-tab--active .q-tab__label,
.tagam-bottom-nav .q-router-link--exact-active,
.tagam-bottom-nav .q-router-link--exact-active .q-icon,
.tagam-bottom-nav .q-router-link--exact-active .q-tab__label {
  color: #f18800 !important;
}

.tagam-bottom-nav .q-tab__indicator {
...
.tagam-footer .q-tab__label {
  font-size: 12px;
  font-weight: 500;
}

.tagam-footer .q-tab--active,
.tagam-footer .q-tab--active .q-icon,
.tagam-footer .q-tab--active .q-tab__label,
.tagam-footer .q-router-link--exact-active,
.tagam-footer .q-router-link--exact-active .q-icon,
.tagam-footer .q-router-link--exact-active .q-tab__label {
  color: #f18800 !important;
}

.tagam-footer .q-tab__indicator {
  display: none !important;
}
</style>
