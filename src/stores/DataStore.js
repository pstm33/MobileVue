...
export const useDataStore = defineStore("datastore", {
  state: () => ({
    ...
    legal_menu: {
      ...
      page_data_deletion: "Account and Data Deletion",
      page_refund_policy: "Refund, Cancellation and Delivery Policy",
      page_support: "Support and Contact",
  ...
  actions: {
    ...
    getAttributes(done) {
      ...
      APIinterface.fetchDataPost("getAttributes", "")
        .then((data) => {
          ...
          this.google_login_enabled = data.details.app_enabled_google_login;
          this.fb_flag = data.details.app_enabled_fb_login;
          this.app_enabled_apple_login = data.details.app_enabled_apple_login;
    ...
    getLoginRedirect(redirect = "/home") {
      const loginMethod = this.login_method;
      return loginMethod === "otp"
        ? "/user/login-otp?redirect=" + redirect
