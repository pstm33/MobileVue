<template>
  ...
  >
    <q-card class="tagam-surface-muted">
      ...
      <q-card-section>
        <div class="row items-center justify-between text-subtitle2 tagam-text-main">
      ...
      <q-card-section class="tagam-surface q-pa-none">
        <q-list dense>
          <q-item header class="tagam-surface-muted text-blue-grey-6">
