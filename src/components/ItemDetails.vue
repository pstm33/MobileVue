      ...
      <template v-else>
        ...
        <q-card-section>
          ...
          <div class="q-mb-sm">
            ...
            <q-option-group v-model="item_size_id" :options="size_data" inline>
          ...
          <div v-if="cooking_data.length > 0" class="q-mb-sm">
            ...
            <div
              v-else
              class="tagam-text-muted text-caption text-weight-medium q-mb-sm"
            >
              {{ $t("Optional") }}
            </div>
            <q-btn-toggle
          ...
          <template v-else>
            ...
            >
              ...
              <q-btn
                ...
                size="lg"
                :class="[
                  'tagam-item-add-btn col-6 tagam-item-add-pulse',
                  { 'tagam-item-add-pulse--active': addPulse },
                ]"
                @click="CheckaddCartItems"
                :disable="disabled_cart"
