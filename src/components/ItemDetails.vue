<template>
  ...
  >
    <q-card class="rounded-borders-top item-sheet">
      <div class="item-sheet__handle-wrap">
...
:deep(.item-sheet .q-btn-toggle) {
  gap: 8px;
  background: transparent;
}

:deep(.item-sheet .q-btn-toggle .q-btn) {
  min-height: 40px;
  padding: 0 14px;
...
:deep(.item-sheet .q-btn-toggle .q-btn--active) {
...
:deep(.item-sheet .addon-carousel) {
  margin-top: 8px;
}
...
:global(body.body--dark) .item-sheet__handle {
  background: var(--tagam-stroke-strong);
}
...
:global(body.body--dark) :deep(.item-sheet .q-btn-toggle .q-btn),
