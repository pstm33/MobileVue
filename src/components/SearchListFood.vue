<template>
  ...
  <q-item-section>
    <q-item-label>
      ...
      <div class="tagam-text-muted ellipsis-2-lines font12 line-normal">
        <span v-html="items.item_description"></span>
      </div>
      <div v-if="items.price" class="tagam-text-muted font12 text-weight-medium">
      ...
      <div class="row items-center justify-between">
        <q-chip size="sm" color="mygrey">
          <span class="tagam-text-main">{{ $t("Food") }}</span>
        </q-chip>
      </div>
    </q-item-label>
  </q-item-section>
