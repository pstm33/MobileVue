<template>
  ...
  <template v-else-if="!loading && !hasData">
    <div class="flex flex-center q-pt-xl q-pb-xl">
      ...
      <p class="tagam-text-muted font12">{{ $t("Let's change that!") }}</p>
    </div>
  </template>
    ...
    >
      <q-card flat class="radius8 q-pa-sm rounded-borders border-greyx">
        <q-img
          ...
          lazy
          fit="cover"
          class="radius8 tagam-restaurant-logo-stretch q-mb-sm"
        ...
        <q-list dense class="qlist-small">
          <q-item>
            <q-item-section>
              <q-item-label
                lines="1"
                :class="{ 'tagam-text-muted': items.saved_store === false }"
                class="font17"
              >
          ...
          <q-item>
            <q-item-section>
              <q-item-label>
                ...
                >
                  <span
                    class="text-weight-medium tagam-text-main"
                    :class="{
                      'tagam-text-muted': items.saved_store === false,
