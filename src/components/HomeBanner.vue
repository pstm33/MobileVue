  ...
  <template v-else>
    <template v-if="hasData">
      <swiper
        ...
        :spaceBetween="12"
        :loop="false"
        class="tagam-home-banner-swiper q-mb-md"
        :autoplay="{
          delay: 2500,
      ...
      >
        ...
        >
          <q-responsive ratio="2">
            <div class="tagam-hero-banner tagam-home-banner-frame cursor-pointer">
              <q-img
                :src="items.image"
                class="tagam-home-banner-image fit"
                fit="cover"
                loading="lazy"
                ...
                spinner-size="md"
              />
              <div class="tagam-banner-gloss"></div>
            </div>
          </q-responsive>
        </swiper-slide>
      </swiper>
...
.tagam-home-banner-frame
  ...
  box-shadow: 0 18px 44px rgba(255, 107, 53, 0.16), var(--tagam-shadow-soft)
  transition: transform 180ms ease, box-shadow 180ms ease

.tagam-home-banner-frame:hover
  transform: translateY(-2px)
  box-shadow: 0 22px 52px rgba(255, 107, 53, 0.22), var(--tagam-shadow)
...
body.body--dark .tagam-home-banner-frame
